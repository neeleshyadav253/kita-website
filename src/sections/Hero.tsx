      ...
      <div className="mx-auto grid w-full max-w-7xl 2xl:max-w-[88rem] 3xl:max-w-[100rem] gap-10 px-4 pb-20 pt-4 sm:gap-12 sm:px-6 sm:pb-24 sm:pt-6 md:grid-cols-[1.05fr,1fr] md:gap-16 md:px-10 md:pb-32 md:pt-10">
        <div className="flex flex-col justify-center text-awo-ink">
          ...
          <div className="mt-8 flex items-center gap-3 text-xs text-awo-grey-light">
            <Shield className="h-4 w-4 text-awo-grass" />
...
const TONE: Record<BadgeProps["tone"], { bg: string; ring: string; icon: string; text: string }> = {
  sun: {
    bg: "bg-awo-sun-soft",
    ring: "ring-awo-sun/20",
    icon: "text-awo-sun",
    text: "text-awo-sun",
  },
  grass: {
    bg: "bg-awo-grass-soft",
    ring: "ring-awo-grass/20",
    icon: "text-awo-grass",
    text: "text-awo-grass",
  },
  lavender: {
    bg: "bg-awo-lavender-soft",
    ring: "ring-awo-lavender/20",
    icon: "text-awo-lavender",
    text: "text-awo-lavender",
  },
  blush: {
    bg: "bg-awo-blush-soft",
    ring: "ring-awo-blush/20",
    icon: "text-awo-blush",
    text: "text-awo-blush",
  },
};
