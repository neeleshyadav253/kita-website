...
import { ArrowRight, Heart, Leaf, MessageCircle, Salad, Shield, Sparkles, Star } from 'lucide-react';
...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="blob -left-24 top-10 h-72 w-72 bg-awo-sun/30 animate-float-slow" aria-hidden="true" />
      <div className="blob right-0 top-40 h-80 w-80 bg-awo-blush/20 animate-float-slower" aria-hidden="true" />
      <div className="blob -bottom-20 left-1/3 h-72 w-72 bg-awo-red-light/30 animate-pulse-slow" aria-hidden="true" />

      <div className="mx-auto grid w-full max-w-7xl gap-10 px-4 pb-20 pt-10 sm:gap-12 sm:px-6 sm:pb-24 sm:pt-12 md:grid-cols-[1.05fr,1fr] md:gap-16 md:px-10 md:pb-32 md:pt-20">
        <motion.div
        ...
        >
          ...
          <h1 className="mt-6 font-display text-4xl font-extrabold leading-[1.05] tracking-tight text-white sm:text-5xl md:text-6xl lg:text-[4.25rem]">
            ...
            <span className="relative inline-block">
              ...
              <svg
                ...
                aria-hidden="true"
              >
                <path d="M0,6 Q50,0 100,4 T200,4" stroke="currentColor" strokeWidth="3" strokeLinecap="round" fill="none" />
              </svg>
            </span>
          </h1>
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            ...
            <Badge icon={MessageCircle} label={t.hero.badges.sprache} tone="lavender" />
        ...
        >
          <div className="absolute -left-8 -top-8 h-32 w-32 rounded-full bg-awo-sun/40 blur-3xl" aria-hidden="true" />
          <div className="absolute -right-6 bottom-8 h-40 w-40 rounded-full bg-awo-blush/30 blur-3xl" aria-hidden="true" />
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] shadow-2xl ring-8 ring-white/10">
            ...
            <motion.div
              ...
              className="absolute left-5 top-5 inline-flex items-center gap-2 rounded-full bg-white/95 px-3 py-1.5 text-[11px] font-bold uppercase tracking-widest text-awo-red shadow-card backdrop-blur"
            >
            ...
            <motion.div
              ...
              className="absolute -left-5 top-32 hidden rounded-2xl bg-white/95 p-3 pr-4 shadow-card-hover backdrop-blur md:flex md:items-center md:gap-3"
            >
              <span className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-awo-grass/15 text-awo-grass">
                <Salad className="h-4 w-4" />
              </span>
              <div className="leading-tight">
                <div className="text-[11px] uppercase tracking-widest text-awo-grey-light">Mittagessen</div>
                <div className="text-sm font-bold text-awo-ink">90 % Bio · frisch</div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="absolute -right-3 top-1/2 hidden -translate-y-1/2 rounded-2xl bg-white/95 p-3 pr-4 shadow-card-hover backdrop-blur md:flex md:items-center md:gap-3"
            >
              <span className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-awo-sun/15 text-awo-sun">
                <Star className="h-4 w-4 fill-current" />
              </span>
              <div className="leading-tight">
                <div className="text-[11px] uppercase tracking-widest text-awo-grey-light">Eltern-Bewertung</div>
                <div className="text-sm font-bold text-awo-ink">4,9 / 5 · 56 Stimmen</div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="absolute bottom-6 left-6 right-6 flex items-start gap-3 rounded-2xl bg-white/95 p-4 pr-5 shadow-card backdrop-blur"
            >
