        ...
        <div className="relative grid gap-8 lg:grid-cols-[1.4fr,1fr] lg:items-center">
          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-3">
              <Stat number="48 h" label="Antwortzeit" tone="bg-awo-sun-soft text-awo-sun ring-awo-sun/20" />
              <Stat number="0 €" label="Beiträge in Berlin" tone="bg-awo-grass-soft text-awo-grass ring-awo-grass/20" />
              <Stat number="14 Tg" label="bis zum Erstgespräch" tone="bg-awo-blush-soft text-awo-blush ring-awo-blush/20" />
              <Stat number="4,9 ★" label="Eltern-Bewertung" tone="bg-awo-lavender-soft text-awo-lavender ring-awo-lavender/20" />
            </div>
          </div>
        </div>
      </motion.div>
